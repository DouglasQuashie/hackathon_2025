	...
	return (
		<nav className="flex items-center justify-between py-4">
            <div className='flex items-center space-x-4'>
                ...
                <Button onClick={() => location.replace("/catastrophe")} className='cursor-pointer bg-red-600 text-white hover:bg-white hover:text-red-600'>Ajouter une catastrophe</Button>
